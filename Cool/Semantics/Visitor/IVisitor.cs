...
namespace Cool.Semantics
{
    public interface IVisitor
    {
        ...
        void Visit(FormalNode formalNode, IScope scope, ICollection<string> errors);
        ...
        void Visit(ExpressionNode.VoidExpression node, IScope scope, ICollection<string> errors);
